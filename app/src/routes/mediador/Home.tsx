...
export function MediadorHome() {
  const { mediadorProfile } = useAppState();
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <div className="rounded-xl bg-leaf-100 p-3 text-center">
              <p className="font-display font-extrabold text-lg text-leaf-800">3</p>
              <p className="text-[10px] text-leaf-800/80">pedidos de ajuda</p>
            </div>
            <div className="rounded-xl bg-sand-100 p-3 text-center">
              <p className="font-display font-extrabold text-lg text-sand-800">1</p>
              <p className="text-[10px] text-sand-700">missão concluída</p>
            </div>
          </div>
        </div>
